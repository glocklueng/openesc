...
{	
	...
	// record evidence that the parameters have been saved
...
{	
	...
	if (MyVariable[22] == 0)	// there are no parameters in the flash
	{
	  	Read_flash_default_params();
	  	return true;
	}
	else if (MyVariable[22] == 1) // there are parameters in the flash
	{
