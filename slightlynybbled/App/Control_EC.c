...
void	Save_temp_data(void)
{
	...
	ADC_InjectedConvertedValueTab[cnt_buff] = EC.Event; 
	ADC_RegularConvertedValueTab[cnt_buff] = tempPWM >> 1;
...
void ControlEC_Task(void *param)
{
	...
	Init_Control_EC(TIM1, PeriodPWM, CCR_Val, 100);
...
void TIM1_UP_IRQHandler(void)
{
	...
	*/
	...
	switch(State)
	{
		...
		case	STATE_PREPOS:
		  	Set_current(TIM1, &EC, tempPWM);
			TIM_SetCompare4(TIM1, tempPWM >> 1);
		break;
...
void	State_Stop(void)
{
	...
	{
	  	// initialize the current regulator
